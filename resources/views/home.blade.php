...
-->
    ...
    <!-- ***** En esta area vamos a incluir la vista menu para mover el menu de comida fuera de la vista home ***** -->
    @include("menu")

    <!-- ***** En esta area vamos a incluir la vista de los Chef para mover el codigo a una vista aparte. ***** -->
    @include("chef")

    <!-- ***** Para manejar las reservacion separamos el codigo y creamos un bladde.php con el codigo fuente ***** -->
    @include("reservation")
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <br>Design: Jose Osvaldo Morillo Villar & Wilman Moral</p>
                    </div>
                </div>
            </div>
        </div>
